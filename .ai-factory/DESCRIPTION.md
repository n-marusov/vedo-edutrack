...
Formal NFR corpus: **54 NFR** in `specs/requirements/REQ-NFR-*.md`, each with measurable acceptance criteria, traced in `traceability.ttl`. Coverage areas:
...
Total requirements corpus: **114** (60 FR + 54 NFR), plus 42 UC and 47 US, all traced in `traceability.ttl` (0 orphans).
