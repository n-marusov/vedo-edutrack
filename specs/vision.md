...
- **[G5] Сетевой:** Публичная онтология растёт: 1000+ тем на старте, 5000+ через 3 года. Каждый вклад методиста увеличивает ценность маршрутов для всех пользователей (онтология и вклад методистов — зона VEDO Hub; фреймворк потребляет обновления через API, F6).
...
| **5** | **F4: Визуализация графа знаний и маршрута** | Карта знаний: граф тем и связей с подсветкой прогресса. Дашборд ученика: «доступно сейчас», «критический путь», «план и факт». Конструктор маршрутов: выбор цели → визуализация маршрута. | Понимание структуры знаний с первого взгляда. Прозрачность для родителя и HR. |
...
- Корпоративные сценарии (онбординг, карьерные треки, соблюдение требований) — не функции фреймворка, а вертикаль «Вектор Компетенций» (reference-приложение), развивается отдельно.
...
- Корпоративная вертикаль «Вектор Компетенций»: онбординг, карьерные треки, обучение соблюдению требований (привязка регуляторных требований к модулям и рабочим сценариям) — на универсальных механиках фреймворка.
...
*Рейтинг и бейджи контрибьюторов, DOI-регистрация — функции VEDO Hub, не фреймворка.*
