...
- Владение API: EduTrack отдаёт API маршрутов/планов/прогресса/покрытия/визуализации, read-only SPARQL-прокси, webhooks, MCP; Hub отдаёт REST/MCP/SPARQL онтологии и CRUD/форки/merge (0 дублирования: SPARQL-эндпоинт EduTrack — прокси, не отдельное хранилище).
